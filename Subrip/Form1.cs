...
namespace SubripCapture
{
    ...
    public partial class Form1 : Form
    {
        ...
        public void SaveSelection(bool showCursor)
        {
            ...
            Point screenTL = PointToScreen(CurrentTopLeft);
            Point screenBR = PointToScreen(CurrentBottomRight);

          

            Rectangle bounds = new Rectangle(Convert.ToInt32(screenTL.X * 1.5), Convert.ToInt32(screenTL.Y * 1.5), Convert.ToInt32((screenBR.X - screenTL.X)*1.5), Convert.ToInt32((screenBR.Y - screenTL.Y)*1.5));
                               
                Rectangle cursorBounds = new Rectangle(curPos, curSize);

            
               
                ((FormRip) this.InstanceRef).CaptureArea = bounds;
